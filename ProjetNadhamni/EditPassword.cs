...
namespace ProjetNadhamni
{
    public partial class EditPassword : Form
    {
        ...
        private void txt_pwdUpdated_Click(object sender, EventArgs e)
        {
            txt_pwdUpdated.Clear();
        }
        ...
        private void btn_updatePwd_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("update Profile set Password=@Password where UserName='" + Home.FK + "'", con);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@Password", txt_pwdUpdated.Text);
                cmd.ExecuteNonQuery();
